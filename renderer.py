...
class Renderer():
    ...
    def __init__(self):
        ...
        self.root.configure(bg="#1D1D1D", padx="15", pady="25")
        self.calculator = Calculator()
        self.output_box = Entry(self.root, fg="#FEFEFE", font=("Consolas 15"), readonlybackground="#555555", justify="right")
    ...
    def render(self):
        ...
        button_0 = Button(self.root, text="0", bg="#2D2D2D", fg="#EEEEEE", width=5, height=2, font=("Consolas 12"))
        ...
        for i in range (1, 10):
            current_button = Button(self.root, text=str(i), bg="#2D2D2D", fg="#EEEEEE", width=5, height=2, font=("Consolas 12"))
        ...
        for operator in operators:
            current_button = Button(self.root, text=operator, bg="#2D2D2D", fg="#EEEEEE", width=5, height=2, font=("Consolas 12"))
            current_button.config(command=partial(self.calculator.append_expression, current_button.cget("text")))
            current_button.grid(row=current_row, column=4)
            current_row += 1

        decimal_button = Button(self.root, text=".", bg="#2D2D2D", fg="#EEEEEE", width=5, height=2, font=("Consolas 12"))
        ...
        equals_button = Button(self.root, text="=", bg="#2D2D2D", fg="#EEEEEE", width=5, height=2, font=("Consolas 12"))
